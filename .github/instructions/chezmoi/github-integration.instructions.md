---
description: this file is about the template functions for github integration, used when the user needs to retrieve or download information from github, especially when dealing with externals.
applyTo: "home/**/*.tmpl"
---
